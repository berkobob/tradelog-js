...
app.engine(
    ...
    exphbs({
        ...
        helpers: {
            ...
            putOrCall: trades => trades[0].putOrCall,
            expiry: trades =>
                trades[0].expiry
                    ? moment(trades[0].expiry).format("DD/MM/YY")
                    : "",
            strike: trades =>
                trades[0].strike ? numeral(trades[0].strike).format() : "",
            multiplier: trades => trades[0].multiplier,
        },
    }),
);
